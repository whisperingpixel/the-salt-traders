...
#  - Creating Shapely geometries (Point, Linestring)
...
if __name__ == "__main__":
    ...
    class Game(cmd.Cmd):
        ...
        market by typing 'add_market <name> <latitude> <longitude>', e.g.
        'add_market Burghausen 48.16925 12.83139'.
        """
        ...
        def do_add_market(self, args):
            ...
            name, lat, lon = args.split()
            wkt_geometry = f"POINT({lat} {lon})"
